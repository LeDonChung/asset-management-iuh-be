    ...
    const managerPermissions = [
      ...
      },
      {
        ...
        permissions: [
          ...
          {
            name: "Tiếp nhận",
            code: PermissionConstants.PERM_RECEIVE_TRANSACTION,
          },
          {
            name: "Phê duyệt",
    ...
    const roleConfigs = [
      ...
      },
      {
        ...
        permissions: [
          ...
          PermissionConstants.PERM_RESOLVE_ALERT,
          PermissionConstants.PERM_VIEW_ALERT,
          ...
          PermissionConstants.PERM_VIEW_LIQUIDATION,
      ...
      },
      {
        ...
        permissions: [
          ...
          PermissionConstants.PERM_RECEIVE_TRANSACTION,
          PermissionConstants.PERM_UPDATE_TRANSACTION,
          PermissionConstants.PERM_REMOVE_TRANSACTION,
